...
import 'package:forc/pages/reportpage.dart';
...
class _StudentProfilePageState extends State<StudentProfilePage> {
  ...
  void _openBehaviourIncidentPage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BehaviourIncidentPage(
          student: _s, // ✅ Pass the whole model
          onIncidentLogged: (incident) {
            setState(() => _incidents.add(incident));
          },
        ),
      ),
    );
